...
async function fetchLeadsPageWebhook({
  ...
  try {
    ...
    if (emails.length === 0) {
      console.log('⚠️ No unprocessed emails found.');
      return {
        items: [],
    ...
    // ✅ 4️⃣ Return Instantly API data (so your caller gets it)
